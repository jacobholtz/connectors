...
class ExtendedAttributeItem(MISPBaseModel):
    ...
    distribution: DistributionLevelId | None = Field(
...
class ExtendedEvent(MISPBaseModel):
    ...
    analysis: AnalysisLevelId | None = Field(default=None, coerce_numbers_to_str=True)
    ...
    threat_level_id: ThreatLevelId | None = Field(
        default=None, coerce_numbers_to_str=True
    )
